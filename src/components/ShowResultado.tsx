...
const ShowResultado = () => {
    ...
    return (
        <div className='flex flex-col w-9/12 lg:w-fit m-auto gap-2 pt-4'>
            <div className='text-center text-3xl dark:text-secondary relative rounded dark:bg-secondary-foreground bg-muted px-[0.3rem] py-[0.2rem] font-mono font-semibold'>
                {resultado}
            </div>
